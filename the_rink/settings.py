"""
Django settings for the_rink project.
...
SECRET_KEY = 'django-insecure-pho5!u&(=wpym6@^7$g2g8%img#ll1+aqshrpbg*vofo34-esl'
...
WSGI_APPLICATION = 'the_rink.wsgi.application'
...
# Cross-site Cookie (localhost -> pbp.cs.ui.ac.id)
